...
Route::get('/events/with-users', [EventUserController::class, 'getAllEventsWithUsers']);
Route::get('/users/with-events', [EventUserController::class, 'getAllUsersWithEvents']);
